...
class TestNiff2Tri(unittest.TestCase):
    ...
    def test_niff2_tri_node_builder(self, _, index, vtx_indices, expected_size):
        ...
        self.assertEqual(tri.tri_nv_index, 0xFFFFFFFF)
        self.assertEqual(tri.tri_color_index, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_index0, 2)
        self.assertEqual(tri.st_index0, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_nv_index0, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_color_index0, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_index1, 3)
        self.assertEqual(tri.st_index1, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_nv_index1, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_color_index1, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_index2, 4)
        self.assertEqual(tri.st_index2, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_nv_index2, 0xFFFFFFFF)
        self.assertEqual(tri.vtx_color_index2, 0xFFFFFFFF)
