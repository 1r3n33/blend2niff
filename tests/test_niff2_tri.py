...
class TestNiff2Tri(unittest.TestCase):
    ...
    def test_niff2_tri_group_node_builder(self, _, index, name_index, vtx_group_index, vtx_indices, expected_size):
        ...
        self.assertEqual(tri_group.vtx_color_group_index, 0)
