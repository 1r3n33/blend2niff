...
from blend2niff.exporter.niff2_mat import (
    niff2_mat_list_header_builder, niff2_mat_node_builder)


class TestNiff2Mat(unittest.TestCase):
    def test_niff2_mat_list_header_builder(self):
        mat_node = niff2_mat_node_builder(123, 456)
        materials = [mat_node]
        ...
        self.assertEqual(mat_list_header.mat_num, len(materials))
    ...
    def test_niff2_mat_node_builder(self):
        ...
        self.assertEqual(mat_node.mat_shade_type, 0x00000010)
        ...
        self.assertEqual(mat_node.prim_red, 0.8)
        self.assertEqual(mat_node.prim_green, 0.1)
        self.assertEqual(mat_node.prim_blue, 0.1)
        self.assertEqual(mat_node.prim_alpha, 1.0)
        ...
        self.assertEqual(mat_node.local_light_index, 0xFFFFFFFF)
