...
class Niff2VtxGroupNode:
    vtx_group_tag: int
    this_vtx_group_index: int
    vtx_group_header_size: int
    vtx_group_size: int
    vtx_group_name_index: int
    vtx_num: int
...
def niff2_vtx_group_node_builder(vtx_group_index, vtx_group_name_index):
    vtx_group = Niff2VtxGroupNode()
    vtx_group.vtx_group_tag = TAG_VTX_GROUP
    vtx_group.this_vtx_group_index = vtx_group_index
    vtx_group.vtx_group_header_size = 6*4
    vtx_group.vtx_group_size = 6*4
    vtx_group.vtx_group_name_index = vtx_group_name_index
    vtx_group.vtx_num = 0
    return vtx_group
